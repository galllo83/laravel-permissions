        ...
        <div class="max-w-7xl  mx-auto py-4">
            ...
            <div class="mt-6">
                <Table>
                    ...
                    <template #default>
                        <TableRow v-for="user in users" :key="user.id" class="hover:bg-gray-50 dark:hover:bg-gray-400">
                            ...
                            <TableDataCell class="space-x-4">
                                ...
                                <Modal :show="showConfirmDeleteUserModal" @close="closeModal">
                                    <div class="p-6">
                                        <h2 class="text-lg font-semibold text-slate-800">Are you sure to delete {{ user.name }} user?</h2>
